...
[![Tests](https://img.shields.io/badge/tests-488%20live%20%2B%20748%20offline-brightgreen.svg)](tests/FEATURES.md)
...
plugin host, a mobile-device mirror, and an AI console that drives seven
assistants through the CLI each vendor ships.
...
Nova follows [semantic versioning](https://semver.org), currently **1.2.1**.
